...
같은 관계 단계·카테고리 조합이라도 매번 다른 문장 구조로 시작할 것.
아래 시작 패턴 중 매번 다른 것을 무작위로 선택해서 사용하라:

(a) 이전 접점/상황을 먼저 언급 후 자료 소개
(b) 업계/트렌드 언급 후 자료로 연결
(c) 고객의 고민을 먼저 짚은 후 자료 소개
(d) 담백하게 자료 소개부터 시작

같은 시작 패턴을 연속으로 반복하지 말 것.
